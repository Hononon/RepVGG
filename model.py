...
def create_RepVGG_A2(deploy=False, use_checkpoint=False, num_classes=1000):
...
def create_RepVGG_B1g2(deploy=False, use_checkpoint=False, num_classes=1000):
...
if __name__ == "__main__":
    ...
    model = create_RepVGG_A2(num_classes=5)
    y = model(a)
    print(y)
    # 统计模型参数
    sum = 0
